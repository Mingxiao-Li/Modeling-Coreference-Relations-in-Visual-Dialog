...
from bert_pos_utils import batch_iter
from bert_pos_train import forward
from utils.metrics import scores_to_ranks, SparseGTMetrics, NDCG
from params import read_command_line
from bert_pos_net import VDModel
from bert_pos_dataloader import VDDataset
...
if __name__ == "__main__":
    ...
    params["start_path"] = "../model_checkpoints/visdial_pos.ckpt"
    params[
        "visdial_processed_val"
    ] = "../../data/visdial/data_with_co.json"  # data_without_pro.json"
