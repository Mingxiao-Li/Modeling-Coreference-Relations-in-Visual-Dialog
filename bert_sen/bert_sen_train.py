...
if __name__ == "__main__":
    ...
    params[
        "continue_path"
    ] = "checkpoints/07-Sep-20-13:00:01-Mon_8081024/visdial_dialog_153980.ckpt"
    # params["overfit"] = True
    ...
    for epoch_id, idx, batch in batch_iter(train_dataloader, params):
        ...
        # fire evaluation
        if iter_id % (num_iter_epoch * 500) == 0 and iter_id > 0:
