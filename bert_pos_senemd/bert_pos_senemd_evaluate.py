...
from bert_pos_senemd_utils import batch_iter
from bert_pos_senemd_train import forward
...
def evaluate(visual_dialog, params, eval_batch_size, dataloader):
    ...
    with torch.no_grad():
        ...
        for epoch_id, _, batch in batch_iter(dataloader, params):
            ...
            pos_tag = pos_tag.view(-1, pos_tag.shape[-1])
            ...
            for j in range(eval_batch_size * num_rounds * num_options // batch_size):
                ...
                item["pos_tag_ids"] = pos_tag[j * batch_size : (j + 1) * batch_size, :]
                ...
                nsp_scores, _ = forward(visual_dialog, item, params, evaluation=True)
...
if __name__ == "__main__":
    ...
    params[
        "start_path"
    ] = "checkpoints/17-Oct-20-21:27:25-Sat_2703952/visdial_dialog_615920.ckpt"
    # params["visdial_processed_val"] = "../../data/visdial/core_val/visdial_val_co6.json"
    ...
    print("data sample", len(dataloader))
    ...
    if split == "test":
        evaluate_test_set(
            dataloader, visual_dialog, params, eval_batch_size, split=split
        )
    else:
